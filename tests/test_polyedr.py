...
4	1    4    8    5"""
    ...
    def test_sum01(self):
        self.assertEqual(Polyedr('data/box.geom').edges_lenght(), 0)

    def test_sum02(self):
        self.assertEqual(Polyedr('data/ccc.geom').edges_lenght(), 0)

    def test_sum03(self):
        self.assertEqual(Polyedr('data/king.geom').edges_lenght(), 0)

    def test_sum04(self):
        self.assertAlmostEqual(Polyedr('data/babem.geom').edges_lenght(), 60.23695439)

    def test_sum05(self):
        self.assertAlmostEqual(Polyedr('data/cow.geom').edges_lenght(), 147.2938589)
